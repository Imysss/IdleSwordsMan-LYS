...
{
    //가챠 타입별 누적 경험치, 현재 레벨 관리
    private Dictionary<GachaType, int> gachaExp = new Dictionary<GachaType, int>();
    private Dictionary<GachaType, int> gachaLevel = new Dictionary<GachaType, int>();
